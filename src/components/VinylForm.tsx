      ...
      <div className="form-grid">
        ...
        <div className="form-field">
          ...
          <input
            ...
            aria-describedby={
              catalogNumberError ? fieldErrorId("catalogNumber") : undefined
            }
            autoComplete="off"
            required
            disabled={isPending}
        ...
        <div className="form-field">
          ...
          <input
            ...
            aria-describedby={
              pricePaidError ? fieldErrorId("pricePaid") : undefined
            }
            required
            disabled={isPending}
          />
        ...
        <div className="form-field">
          ...
          <select
            ...
            aria-describedby={
              conditionError ? fieldErrorId("condition") : undefined
            }
            required
            disabled={isPending}
          >
        ...
        <div className="form-field">
          ...
          <input
            ...
            aria-describedby={
              acquiredAtError ? fieldErrorId("acquiredAt") : undefined
            }
            required
            disabled={isPending}
          />
        ...
        <div className="form-field form-field--checkbox">
          <label htmlFor="vinyl-isColoredVinyl" className="checkbox-label">
            <input
              ...
              aria-describedby={
                isColoredVinylError ? fieldErrorId("isColoredVinyl") : undefined
              }
              disabled={isPending}
            />
          ...
          {isColoredVinylError ? (
            <p
              id={fieldErrorId("isColoredVinyl")}
              className="field-error"
              role="alert"
            >
              {isColoredVinylError}
